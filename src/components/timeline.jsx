        ...
        <Tabs defaultValue="visual">
          ...
          <TabsContent value="analysis" className="mt-6">
            <div className="prose max-w-none">
              <h3>Infrastructure Development and Cultural Expression</h3>
              <p>
                The timeline above illustrates the intricate relationship
              ...
              <h4>Creating the Space for Cultural Exchange</h4>
              <p>
                The development of highways connecting previously isolated
                regions created new opportunities for cultural exchange and the
                dissemination of regional expressions. As travel between regions
                became more frequent and accessible, there developed a need for
                entertainment that could bridge the gap between traditional
                values and modern mobility practices.
              </p>

              <h4>The 11-Hour Journey Phenomenon</h4>
              <p>
                The completion of the Highway Linking Hail to Eastern Province
              ...
              <h4>Infrastructure Networks as Distribution Networks</h4>
              <p>
              ...
              <h4>Technology Transitions and Cultural Preservation</h4>
              <p>
              ...
              <p>
                This analysis demonstrates how infrastructure development does
                not merely facilitate practical transportation but creates the
                conditions for new cultural forms to emerge, flourish, and
                eventually transform. The Abu Maluh phenomenon cannot be
                understood without recognizing the critical role played by Saudi
                Arabia's highway development program in creating both the
                physical context for long journeys and the cultural need for
                appropriate entertainment during those journeys.
              </p>
            </div>
          </TabsContent>
        </Tabs>
